...
Motivation: Does completion come from feedback, or from belonging? AI can close the feedback gap. Can it close the community gap?
Gaming: What happens when learners use AI to write the submissions that AI evaluates?
Cost drift: Token prices keep falling, but learners will want more dialogue. Which way does the bill actually move?
